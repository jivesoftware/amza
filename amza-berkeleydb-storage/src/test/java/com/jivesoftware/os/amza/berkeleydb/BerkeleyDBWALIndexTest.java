...
public class BerkeleyDBWALIndexTest {
    ...
    public void testPut() throws Exception {
        ...
        index.merge(stream -> stream.stream(1L, UIO.longBytes(-1), UIO.longBytes(1), null, System.currentTimeMillis(), false, Long.MAX_VALUE, 1L),
            null);
        ...
        index.merge(stream -> stream.stream(2L, UIO.longBytes(-2), UIO.longBytes(2), null, System.currentTimeMillis(), false, Long.MAX_VALUE, 2L),
            null);
    ...
    public void testRangesNoPrefix() throws Exception {
        ...
        index.merge((TxKeyPointerStream stream) -> {
            for (long i = 0; i < 64; i++) {
                ...
                if (!stream.stream(i, null, key, null, System.currentTimeMillis(), false, Long.MAX_VALUE, i)) {
                    return false;
                }
            }
            return true;
    ...
    private BerkeleyDBWALIndex getIndex(File dir, VersionedPartitionName partitionName) throws Exception {
        return new BerkeleyDBWALIndexProvider("berkeleydb", 1, new File[]{dir}).createIndex(partitionName, -1, 0);
    }
