...
import com.jivesoftware.os.amza.transport.http.replication.HttpAvaliableRowsTaker;
...
public class Main {
    ...
    public void run(String[] args) throws Exception {
        ...
        AvailableRowsTaker availableRowsTaker = new HttpAvaliableRowsTaker(amzaStats);
