 ...
 */
public class DiskBackedPointerIndexFilerChannelWriter implements IWriteable {

    private final DiskBackedPointerIndexFiler parent;
    private final FileChannel fc;
    private long fp;

    public DiskBackedPointerIndexFilerChannelWriter(DiskBackedPointerIndexFiler parent, FileChannel fc) {
        this.parent = parent;
        this.fc = fc;
    }
